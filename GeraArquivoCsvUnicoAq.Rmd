...
selectCsv = function(fileCsv){
  ...
  dataframeCsv <-
    filter(dataframeCsv,
           ...
           & (AQ_ESTADI==0|AQ_ESTADI==1|AQ_ESTADI==2|AQ_ESTADI==3|AQ_ESTADI==4) #Apenas Estadio preenchido com 0,1,2,3 e 4
...
diretorioCsvs <- "~/datasus.gov.br/SIASUS/AQ-LaudosDiversos/CSVs202103"
arquivoCsvComTudo <- "~/SIA_SUS/SIA_SUS/CSV/AQ_Estadios.csv"
arquivoCsvComTudoAgrupado <- "~/SIA_SUS/SIA_SUS/CSV/AQ_Estadios_Agrupado.csv"
